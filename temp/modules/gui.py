...
class GUI:
    ...
    def create_buttons(self):
        ...
        # Configure only the rows that will contain buttons to remove extra space
        ...
        # Right button frame in column=2 remains mostly unchanged
        ...
        # Adjusting spacing by configuring only used rows or altering minsize
        for i in range(4):
        ...
        self.makcu_button.grid(row=0, column=0, padx=0, pady=5, sticky="e")
        ...
        self.control_button.grid(row=1, column=0, padx=0, pady=5, sticky="e")
        ...
        self.open_log_button.grid(row=2, column=0, padx=0, pady=5, sticky="e")
    ...
    def offline_flash_dialog(self):
        ...
        # Minimal log so the user knows to pick a local firmware file
    ...
    def quit_application(self):
        ...
        """
        try:
            # Disable monitoring to stop auto-connect
            self.serial_handler.monitoring_active = False

            # Ensure the UART speed is set to 115200 before quitting
            if self.serial_handler.is_connected and self.serial_handler.serial_connection:
                self.serial_handler.set_baud_rate(115200)  # Set baud rate to 115200
                time.sleep(0.010)  # 10ms delay to ensure the operation completes
