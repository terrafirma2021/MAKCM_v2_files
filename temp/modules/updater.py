...
class Updater:
    ...
    def check_for_updates(self):
        ...
        def task():
            try:
                # Ping github.com 3 times to check if online
                response = os.system("ping -n 3 -w 300 github.com > nul 2>&1" if os.name == "nt" else "ping -c 3 -W 10 github.com > /dev/null 2>&1")
                if response != 0:
